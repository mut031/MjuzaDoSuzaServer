...
var SearchResultComponent = /** @class */ (function () {
    function SearchResultComponent(http, toastController) {
        this.http = http;
        this.toastController = toastController;
        this.isAdding = false;
    }
    SearchResultComponent.prototype.ngOnInit = function () { };
    SearchResultComponent.prototype.presentToastWithOptions = function (data) {
...
var UserPage = /** @class */ (function () {
    function UserPage(http, route, router) {
        this.http = http;
        this.route = route;
        this.router = router;
        this.items = [];
    ...
    UserPage.prototype.apiUrl = function (query) {
    ...
    //     });
    // }
    UserPage.prototype.onSearch = function (e) {
        var _this = this;
    ...
    UserPage.prototype.filterResults = function (data) {
        ...
        this.items = data.results
            .filter(function (item) { return item.video.duration !== 'Playlist'; })
            .map(function (item) {
            return {
                _id: item.video.id,
