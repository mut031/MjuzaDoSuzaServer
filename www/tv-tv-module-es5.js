...
var PlaylistItemComponent = /** @class */ (function () {
    function PlaylistItemComponent(http) {
        this.http = http;
    ...
    PlaylistItemComponent.prototype.removeFromPlaylist = function () {
        var _this = this;
...
var TvPage = /** @class */ (function () {
    ...
    TvPage.prototype.updatePlaylist = function () {
        this.getPlaylist();
    };
    ...
    TvPage.prototype.playNextSong = function () {
    ...
    TvPage.prototype.playSongOnClick = function (id) {
        var oldId = this.items[this.currentSongIndex].id;
        this.items[this.currentSongIndex].isCurrent = false;
        this.currentSongIndex = this.items.findIndex(function (item) { return item.id === id; });
        this.items[this.currentSongIndex].isCurrent = true;
        this.currentSong = this.items[this.currentSongIndex];
    ...
    TvPage.prototype.updateCurrentSong = function (oldId) {
        this.http.put(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].SERVER_URL + "/playlist", { id: this.currentSong.id, isNew: true })
            .subscribe(function (data) { return console.log('put response', data); });
